...
class Tool
{
     ...
     * @var string
     */
    public $result_format = "json";  //返回格式
     ...
     * @param $sign 签名
     * @param $data 待验签字符串
     * @param $public_key 公钥匙
     * @return bool
     * @author EricGU178
     */
    public function notifyVerifySign($data,$sign,$public_key)
    {
        $sign = $data['sign'];
        ...
        $str = rtrim($str, '&');
        $public_key = $this->formatPubKey($public_key);
